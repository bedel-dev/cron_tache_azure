...
export async function Cron3(myTimer: Timer, context: InvocationContext): Promise<void> {
    try {
        const response = await axios.post(API_BASE_URL+'/v1.4/agences/traitMasse.json', { /* Données à envoyer */ });
